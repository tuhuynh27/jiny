...
- [OpenJDK 1.8](https://adoptopenjdk.net/)
- Consider using [SDKMAN!](https://sdkman.io/) for convenient installation of JDK.

## How to build

We use [Gradle](https://gradle.org/) to build Jiny.
The following command will compile Jiny, run tests and generate JARs:
...
You can import Jiny into your IDE ([IntelliJ IDEA](https://www.jetbrains.com/idea/) or [Eclipse](https://www.eclipse.org/)) as a Gradle project.
